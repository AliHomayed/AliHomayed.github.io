...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <nav className="py-8 px-10 flex justify-between dark:text-white md:px-5">
            ...
            <ul className="flex items-center ">
              ...
              <li >
                <a
                  className="bg-teal-500 text-white px-6 py-2.5 text-xl border-none rounded-md ml-8 md:ml-5"
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section>
          ...
          <div className="mx-auto rounded-full w-40 h-40  relative overflow-hidden mt-8 ">
